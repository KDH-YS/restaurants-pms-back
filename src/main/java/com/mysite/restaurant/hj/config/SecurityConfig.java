...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers("/api/notices/**").permitAll()// 인증 없이 허용할 경로
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		// 특정 도메인만 허용
		configuration.setAllowedOrigins(List.of("http://206.189.35.254:8183", "http://206.189.35.254:8283","http://cofile.co.kr:8183/","http://cofile.co.kr:8283/","https://restaurant-pms-front-user.vercel.app/","https://restaurant-pms-front-admin.vercel.app/","https://rechelin.vercel.app/"));
